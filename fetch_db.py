...
def get_db():
    ...
    client = MongoClient('mongodb+srv://small_wind:persian@cluster0-enyp4.mongodb.net/test?retryWrites=true&w=majority')#need to replace local host with server path
